...
<a href="https://github.com/utkucaglar/NFC_Link" data-port="01">
  <img width="100%" src="./assets/port-01-platform-board.svg" alt="PLATFORM BOARD: NFC_LINK — TYPESCRIPT, REACT, SUPABASE">
</a>

<a href="https://github.com/utkucaglar/CS445-Project" data-port="02">
  <img width="100%" src="./assets/port-02-compute-assembly.svg" alt="COMPUTE ASSEMBLY: CS445_PROJECT — NLP, REGRESSION, BERT">
</a>

<a href="https://github.com/utkucaglar/YOK_Akademik_MCP" data-port="03">
  <img width="100%" src="./assets/port-03-protocol-drive.svg" alt="PROTOCOL DRIVE: YOK_AKADEMIK_MCP — MCP, SSE, AUTOMATION">
</a>

<a href="https://github.com/utkucaglar/cs308-team9-ecommerce-app" data-port="04">
  <img width="100%" src="./assets/port-04-commerce-memory.svg" alt="COMMERCE MEMORY: PIXELVAULT — NEXT.JS, POSTGRES, N8N">
</a>
